...
Route::group(['middleware'=>'auth'], function(){
	...
	Route::post('/editc/{id}',array('as'=>'conta.update', 'uses'=>'ContasController@update'));
	Route::get('/editc/{id}', array('as'=>'conta.editc', 'uses'=>'ContasController@edit'));
	Route::delete('/destroy/{id}', array('as'=>'conta.destroy', 'uses'=>'ContasController@destroy'));
	...
	Route::post('/editd/{id}',array('as'=>'dispesas.update', 'uses'=>'DispesasController@update'));
	Route::get('/editd/{id}', array('as'=>'dispesas.editd', 'uses'=>'DispesasController@edit'));
	Route::delete('/destroyd/{id}', array('as'=>'dispesas.destroy', 'uses'=>'DispesasController@destroy'));
